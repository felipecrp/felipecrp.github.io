...
- {{< social name="github" url="https://github.com/felipecrp" label="GitHub" >}}
- {{< social name="linkedin" url="https://linkedin.com/in/felipecrp" label="LinkedIn" >}}
- {{< social name="googlescholar" url="https://scholar.google.com.br/citations?user=jXGVY28AAAAJ&hl=en" label="Google Scholar" >}}
- {{< social name="bluesky" url="https://bsky.app/profile/felipecrp.bsky.social" label="Bluesky" >}}
- {{< social name="x" url="https://x.com/felipecrp" label="X (Twitter)" >}}
